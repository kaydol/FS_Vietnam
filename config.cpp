...
class CfgVehicles 
{
	...
	*/
	...
	class Invisible_Minigun_Turret : StaticWeapon {
		model = "\FS_Vietnam\Vehicles\HelipadEmpty_F.p3d";
		crew = "B_Soldier_F";
		typicalCargo[] = {};
		side = TWest;
		faction = "BLU_F";
		displayName = "Shurik Popadaev";
		...
		armor = 500;
		armorStructural = 500;
		damageResistance = 0.00047;
		ejectDamageLimit = 0.75;
		cost = 1500000;
		camouflage = 1.9;	// how dificult to spot - bigger - better spotable
		radarType = 2;
		...
		transportSoldier = 0;
		transportAmmo = 0;
		memoryPointSupply = "pos_gunner";
		supplyRadius = 5;
		LockDetectionSystem = 2 + 8 + 4;
		incomingMissileDetectionSystem = 16;

		extCameraPosition[] = {0, 1.5, -12};
		...
		class Turrets : Turrets {
			class MainTurret : MainTurret {
				...
				startEngine = false;
				maxHorizontalRotSpeed = 3.0;
				maxVerticalRotSpeed = 3.0;

				weapons[] = {"LMG_Minigun_Transport"};
				magazines[] = {"2000Rnd_65x39_Belt_Tracer_Red","2000Rnd_65x39_Belt_Tracer_Red","2000Rnd_65x39_Belt_Tracer_Red","2000Rnd_65x39_Belt_Tracer_Red","2000Rnd_65x39_Belt_Tracer_Red","2000Rnd_65x39_Belt_Tracer_Red"};
				...
				gunnerOpticsEffect[] = {"OpticsCHAbera1", BWTV};
