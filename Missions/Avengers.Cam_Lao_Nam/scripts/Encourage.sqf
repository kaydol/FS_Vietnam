...
#define DEF_INVUL_LENGTH 19


#define DEF_ABILITY_COOLDOWN 240
#define DEF_ABILITY_RADIUS 10
#define DEF_CD_GLOBAL_VARIABLE Team_Invul_CoolDown
#define DEF_ACTION_ID_GLOBAL_VARIABLE Team_Invul_ActionId
#define DEF_ACTION_TEXT "Encourage"
#define DEF_ACTION_DESCRIPTION "When activated, gain damage immunity for you and allies nearby"
#define DEF_SYSTEMCHAT_EFFECT_RECEIVED "Temporarily immune to damage"
#define DEF_ACTION_SOUND "invul_aura_activated"
...
player createDiaryRecord ["Readme", ["Encourage", format ["<br/>You and allies within %1m are immune to damage for %2 seconds.<br/><br/>The cooldown is %3 seconds and it only ticks while you are alive (also ticks while incapacitated).<br/><br/>", DEF_ABILITY_RADIUS, DEF_INVUL_LENGTH, DEF_ABILITY_COOLDOWN]]];
...
private _fnc_addAction = {
	...
	private _fnc_action = {
		...
		{
			//-- Grant invul
			[_x, DEF_INVUL_LENGTH] remoteExec ["FS_fnc_AddGodmodeTimespan", _x];
		...
		sleep DEF_INVUL_LENGTH;
		
		//-------------------------------
		
		[[_caller, DEF_ACTION_SOUND],{
			["RespawnAdded", ["Perk Deactivated", DEF_SYSTEMCHAT_EFFECT_RECEIVED, '\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\instructor_ca.paa']] call BIS_fnc_showNotification;
			//systemChat format ["Perk Deactivated: %1 - %2", DEF_ACTION_TEXT, DEF_SYSTEMCHAT_EFFECT_RECEIVED];
		}] remoteExec ["call", 0];
	};
