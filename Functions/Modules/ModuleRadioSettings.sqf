...
RADIOCOMMS_ENTITIES_WITH_COMMS = _module getVariable "EntitiesWithComms";
...
if (RADIOCOMMS_ENTITIES_WITH_COMMS 	isEqualType "") then { RADIOCOMMS_ENTITIES_WITH_COMMS = call compile RADIOCOMMS_ENTITIES_WITH_COMMS; };
