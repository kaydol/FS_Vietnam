...
private _friendlyUnits = [_side, "FRIENDLY_UNITS", 30, [_aircraft], "FS_fnc_GetFriendlyUnits"] call FS_fnc_SnapshotWrapper;
...
private _friendlyClusters = [_side, "FRIENDLY_CLUSTERS", 30, [_friendlyUnits, 100, [], _debug], "FS_fnc_Clusterize"] call FS_fnc_SnapshotWrapper;
...
private _priorities = [_side, _clusters_centers, _cluster_sizes, _friendlyUnits, _membership, [50, -50, 100], _debug] call FS_fnc_AssignPriorities;
private _newTarget = _clusters_centers # ( _priorities find (selectMax _priorities) );
