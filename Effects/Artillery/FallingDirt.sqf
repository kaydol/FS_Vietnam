...
if ( DEF_CURRENT_PLAYER distance _explosionPos > 200 ) exitWith {};
...
private _dirt = "#particlesource" createVehicleLocal getPos DEF_CURRENT_PLAYER;
...
[DEF_CURRENT_PLAYER, 0.01] call BIS_fnc_dirtEffect;

private _dust = "#particlesource" createVehicleLocal getPos DEF_CURRENT_PLAYER;
_dust setParticleCircle [0, [0, 0, 0]];
_dust setParticleRandom [0, [10, 10, 0], [0.175, 0.175, 0], 0, 0.25, [0, 0, 0, 0], 0, 0];
_dust setParticleParams [["\A3\data_f\cl_basic", 1, 0, 1], "", "Billboard", 1, 3, [0, 0, -0.2], [0, 0, 0.75], 0, 10, 7.9, 0.075, [1.2, 2, 2], [[0.25, 0.25, 0.25, 0], [0.25, 0.25, 0.25, 0.05], [0.25, 0.25, 0.25, 0]], [0.08], 1, 0, "", "", DEF_CURRENT_PLAYER];
